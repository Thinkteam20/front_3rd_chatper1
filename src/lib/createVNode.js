...
export function createVNode(type, props = {}, ...children) {
    ...
    const validChildren = flatChildren.filter(child => child !== null && child !== undefined && child !== false);

    return {
        type,
        props: props || null, // Ensure that props defaults to null if not provided
